  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        <Button onClick={handleShowAddFreind}>{showAddFriend ? 'Close' : 'Add Freind'}</Button>
      </div>
...
function FormSplitBIll({ selectedFriend, onSplitBill }) {
  ...
  return (
    <form className="form-split-bill"
      ...
      <input type="text"
        value={payedByUser}
        onChange={event => setPayedByUser(Number(event.target.value) > bill ? payedByUser : Number(event.target.value))} />
